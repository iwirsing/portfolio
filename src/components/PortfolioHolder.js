    ...
    return (
        <Layout className='container align-items-center' style={{ backgroundImage: `url(${GardenBed1})`}} >
            ...
            <div className='row' style={{minHeight:"400px"}}>
                ...
                <div className='col-8 col-md-8 col-sm- page-contain mx-auto ' style={{ backgroundColor: 'rgba(255, 255, 255, 0.75)',minHeight:'495px', margin: '1rem', borderRadius: '20px', minWidth:"375px", marginBottom:'2rem', marginTop:'2rem'}}>
                    {renderPage()}
